...
public class JsonElementStoreAdapter extends JsonStoreAdapterFactory implements TreeMapper<Key, JsonElement>, AddressToJsonElementWrapper {
    ...
    public Key write(JsonElement element) throws TreeMapperException {
    	...
    	if (element.isJsonArray())
    	    return save(createJsonArray(asArray(element.getAsJsonArray()),
    		    jsonElementToJsonKeyReferencesFunction));
    ...
    class ConvertJsonElementToKeyFunction implements Function<JsonElement, JsonElement> {
        @Override
