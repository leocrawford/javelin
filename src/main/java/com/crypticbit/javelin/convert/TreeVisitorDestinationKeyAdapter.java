...
public class TreeVisitorDestinationKeyAdapter implements
	...
	public Function<Key, Set<Key>> getTransform(
			VisitorContext<Key, Set<Key>> context) throws VisitorException {
		return context.getRecurseFunction();
	}

	@Override
	public Set<Key> writeList(Key source, List<Set<Key>> list)
			throws VisitorException {
		return collapseSet(source, list);
	}

	@Override
	public Set<Key> writeMap(Key source, Map<String, Set<Key>> map)
			throws VisitorException {
	...
	@Override
	public Set<Key> writeValue(Key source, Object value)
			throws VisitorException {
