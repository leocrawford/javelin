...
/**
 * Parse a thing of type I and return a thing of type B, which can then be further parsed based on type to a list, map,
 * primitive, etc. The lifecycle is:
 * <ol>
 * <li>Start with the root of a tree, referenced by a thing of type I
 * <li>call <code>parse</code> on it, to get something of type B (which could be the same as I). In many cases this will
 * do the remote or db call
 ...
 * @author Leo
 * @param <I>
 *            the identifier for the root of the tree. Could be the object itself or a address for it.
 * @param <B>
