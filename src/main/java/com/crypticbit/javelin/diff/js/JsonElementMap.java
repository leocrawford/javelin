...
public class JsonElementMap implements DifferFactoryElement {
	...
	public SequenceDiff<JsonElement, MapDelta<JsonElement>> createApplicator() {
		return new SequenceDiff<JsonElement, MapDelta<JsonElement>>() {
			...
			@Override
			public void addDelta(JsonElement parent, JsonElement child,
					Object branch) {
			...
			@Override
			protected MapDelta createDelta(JsonElement parent,
					JsonElement child, Object branch) {
				throw new Error();
			}

			private Map<String, JsonElement> convert(JsonElement value) {
				Map<String, JsonElement> map = new HashMap<>();
				for (Entry<String, JsonElement> o : value.getAsJsonObject()
						.entrySet()) {
	...
	public boolean supports(Object object) {
		return (object instanceof JsonElement && ((JsonElement) object)
				.isJsonObject());
	}
