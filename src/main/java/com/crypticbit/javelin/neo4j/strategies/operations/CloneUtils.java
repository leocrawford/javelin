...
class CloneUtils {
    ...
    static Relationship cloneRelationship(Node newStartNode, Node newEndNode, Relationship oldRelationship) {
    ...
    static Relationship cloneRelationshipFromNewStartNode(Node newStartNode, Relationship oldRelationship) {
	return cloneRelationship(newStartNode, oldRelationship.getEndNode(), oldRelationship);
    }

    static Relationship cloneRelationshipToNewEndNode(Node newEndNode, Relationship oldRelationship) {
    ...
    static void copyProperties(Node fromNode, Node toNode, com.crypticbit.javelin.neo4j.types.Parameters.Node[] params) {
