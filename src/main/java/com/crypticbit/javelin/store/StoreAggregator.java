...
public class StoreAggregator implements AddressableStorage {
    ...
    public StoreAggregator(AddressableStorage primary, AddressableStorage secondary) {
	...
	if (primary.checkCas(digest))
	    ...
	    System.out.println("Copying: "+digest+"->"+result);
	...
	return "Aggreagting " + primary.getName() + " and " + secondary.getName();
    }
