...
public class DigestTest {
	...
	public void test() {
		...
		Digest originalDigest = new DigestFactory()
				.getDefaultDigest(randomData);
		...
		assertArrayEquals(originalDigestAsByte,
				recoveredDigestByByte.getDigestAsByte());
		assertEquals(originalDigestAsString,
				recoveredDigestByByte.getDigestAsString());
		Digest recoveredDigestByString = new Digest(originalDigestAsString);
		assertArrayEquals(originalDigestAsByte,
				recoveredDigestByString.getDigestAsByte());
		assertEquals(originalDigestAsString,
				recoveredDigestByString.getDigestAsString());
	}
