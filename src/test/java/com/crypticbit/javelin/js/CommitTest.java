...
public class CommitTest {
	...
	private void show() throws JsonSyntaxException,
			UnsupportedEncodingException, StoreException {
		JGraph jgraph = new JGraph(
				new JGraphModelAdapter<CommitDao, DefaultEdge>(
						Commit.getAsGraphToRoots(new Commit[] {
								jca4.getCommit(), jca1.getCommit() })));
