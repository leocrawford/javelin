...
public class KeyTest {
	...
	public void test() {
		...
		Key originalDigest = new Key(randomData);
		...
		assertArrayEquals(originalDigestAsByte,
				recoveredDigestByByte.getKeyAsBytes());
		assertEquals(originalDigestAsString,
				recoveredDigestByByte.getKeyAsString());
		Key recoveredDigestByString = new Key(originalDigestAsString);
		assertArrayEquals(originalDigestAsByte,
				recoveredDigestByString.getKeyAsBytes());
		assertEquals(originalDigestAsString,
				recoveredDigestByString.getKeyAsString());
	}
